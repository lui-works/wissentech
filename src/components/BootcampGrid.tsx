...
const bootcamps: Bootcamp[] = [
  {
    ...
    description:
      'React, Node.js ve veritabanı mimarileriyle uçtan uca uygulama geliştirme yetkinliği kazanın. Gerçek dünya projeleriyle portföyünüzü oluşturun.',
  ...
  },
  {
    ...
    description:
      'Python, TensorFlow ve makine öğrenmesi modelleriyle büyük veriyi anlamlandırın. AI sektörünün talep ettiği yetkinliklere sahip olun.',
  ...
  },
  {
    ...
    description:
      '.NET, Java ve Python teknolojileriyle güçlü backend sistemleri tasarlayın. SQL ve API mimarileri konusunda uzmanlaşın.',
  ...
  },
  {
    ...
    description:
      'Modern arayüzler geliştirip kullanıcı deneyimini şekillendirin. React, TypeScript ve responsive tasarım prensipleriyle öne çıkın.',
    duration: '3 Ay • Yoğun',
    accentClass: 'text-primary',
    borderHoverClass: 'group-hover:border-primary/30',
    bgHoverClass: 'group-hover:bg-primary',
  ...
  },
  {
    ...
    description:
      'İlişkisel ve NoSQL veritabanı yönetiminde ustalaşın. Veri modelleme, performans optimizasyonu ve güvenlik konularını kavrayın.',
  ...
  },
  {
    ...
    description:
      'Şirketinizin ihtiyaçlarına özel tasarlanmış eğitim programları. Ekibinizi sektörün en güncel teknolojileriyle donatın.',
    ...
    <section className="py-32 px-6 md:px-8 max-w-7xl mx-auto relative">
      ...
      <div className="mb-16 md:mb-20">
        ...
        <p className="text-on-surface-variant text-lg max-w-2xl">
          Sektörün ihtiyaçlarına göre şekillenmiş, proje odaklı ve yoğun eğitim modülleriyle
          uzmanlaşın. Her program işe hazırlık garantisiyle tasarlandı.
        </p>
      </div>
