    ...
    <section className="py-32 px-6 md:px-8 relative overflow-hidden">
      ...
      <div className="max-w-4xl mx-auto relative z-10 text-center">
        ...
        <p className="text-xl text-on-surface-variant mb-12 max-w-2xl mx-auto font-body leading-relaxed">
          Sınırlı kontenjana sahip yeni dönem eğitimlerimizde yerinizi ayırtın. Teknoloji
          kariyerinize sağlam ve stratejik bir adım atın.
        </p>
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
          <button className="bg-gradient-to-br from-primary to-primary-dim text-on-primary font-bold px-12 py-5 rounded-full hover:scale-95 transition-transform duration-300 glow-hover text-lg tracking-tight flex items-center gap-3">
            Hemen Başvur
            <span className="material-symbols-outlined icon-filled text-[24px]">rocket_launch</span>
          </button>
          <button className="px-8 py-5 rounded-full border border-outline-variant/15 text-on-surface font-semibold hover:bg-surface-container-high transition-colors duration-300 text-base">
            Demo Talep Et
          </button>
        </div>
        <p className="text-on-surface-variant/60 text-sm mt-6">
